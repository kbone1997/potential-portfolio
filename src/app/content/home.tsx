...
function Home() {
    ...
    return (
        <div className="flex h-[100vh] mx-[12%] pt-[10%]">
            <div className="w-1/2">
                <p className="font-[600] text-2xl text-black dark:text-white">Hi I am</p>
                <p className="font-[600] text-[32px] text-primary">Muhammad Umair</p>
                <p className="font-[700] text-8xl text-black dark:text-white">UI & UX</p>
                <p className="font-[700] text-8xl text-black dark:text-white text-right">Designer</p>
                <p className="font-[400] text-[21px] py-6 text-justify tracking-wide text-black dark:text-white">
                    Lorem ipsum dolor sit amet consectetur. Tristique amet sed massa nibh lectus netus in. Aliquet donec morbi convallis pretium. Turpis tempus pharetra
                </p>
                <button className="px-14 py-3 rounded bg-primary text-white">
